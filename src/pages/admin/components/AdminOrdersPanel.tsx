    ...
    return (
      ...
      >
        <AdminSectionHeader
          eyebrow="Vendas"
          title="Pedidos"
          description={`${filteredOrders.length} pedido${filteredOrders.length !== 1 ? "s" : ""}${statusFilter !== "ALL" ? ` em ${STATUS_LABELS[statusFilter]}` : " no resultado atual"}.`}
          actions={
            <>
                ...
                <tbody>
                  {filteredOrders.map((o) => (
                    ...
                    >
                      ...
                      <td className="p-4 sm:p-5">
                        <p className="text-xs font-bold uppercase text-white/80 truncate max-w-[140px]">
                          {o.userName || "—"}
                        </p>
                        {o.userEmail && (
                      ...
                      <td className="p-4 sm:p-5">
                        <p className="text-xs font-display font-black text-primary italic">
                      ...
                      <td className="p-4 sm:p-5">
                        ...
                        >
                          {Object.entries(STATUS_LABELS).map(([k, v]) => (
                            <option key={k} value={k} className="bg-[#0A0A0F] text-white">
                              {v}
                            </option>
                          ))}
                        </select>
                      ...
                      <td className="p-4 sm:p-5">
                        <p className="text-[11px] font-mono text-dim whitespace-nowrap">
                  ...
                  <div className="p-4 sm:p-5 border-b border-white/5 bg-white/[0.02]">
                    <div className="flex items-center justify-between mb-1">
                      <div className="flex items-center gap-2">
                        ...
                        <h4 className="text-xs font-black uppercase text-white/80">
                          {stage.label}
                        </h4>
                      </div>
                      <span className="text-[10px] font-black bg-white/5 px-2 py-0.5 rounded-full text-white/40">
                        {stageOrders.length}
                      </span>
                    </div>
                  </div>
                        ...
                        <div onClick={() => onSelectOrder(o)} className="cursor-pointer">
                          ...
                          <div className="flex items-start gap-2.5 mb-2">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <h5 className="text-xs font-black uppercase truncate text-white/80 mt-0.5">
                                {o.userName}
                              </h5>
                            </div>
                          </div>
