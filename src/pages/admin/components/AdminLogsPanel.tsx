        ...
        <div className="space-y-4">
          {logs.map(log => (
            <div key={log.id} className="flex gap-6 p-6 bg-white/[0.02] border border-white/5 rounded-[32px] hover:bg-white/[0.04] transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-black border border-white/5 flex items-center justify-center font-mono text-[10px] font-bold text-dim group-hover:text-primary transition-colors">#{log.id.slice(0,4)}</div>
              ...
              <div className="text-right">
                <p className="text-[10px] text-dim font-black uppercase tracking-widest">Operator</p>
