    ...
    items: [
      {
        ...
        a: "É uma tecnologia que transforma um arquivo digital em um objeto físico real. A máquina deposita plástico derretido camada por camada até formar a peça completa — como construir uma parede tijolo por tijolo, mas de forma automatizada.",
      },
      {
        q: "O que é PLA?",
        a: "PLA (Ácido Poliláctico) é um plástico feito de fontes vegetais como milho ou cana-de-açúcar. É o material mais popular para impressão 3D por ter ótima qualidade visual, ser firme e vir em centenas de cores.",
      },
      {
        q: "Quanto tempo leva para ficar pronto?",
        a: "Em média de 3 a 7 dias úteis, dependendo do tamanho e complexidade da peça. Peças pequenas podem ficar prontas em 24h. Você acompanha o status em tempo real na sua conta.",
      },
      {
        q: "Vocês entregam para todo o Brasil?",
        a: "Sim! Enviamos para qualquer estado via Correios (PAC ou SEDEX). O frete é calculado no checkout antes de você confirmar.",
      },
      {
        q: "Posso pedir um tamanho diferente?",
        a: "Sim! Trabalhamos com tamanhos personalizados dentro do limite da impressora (300×300×350mm). Entre em contato pelo WhatsApp com as dimensões desejadas.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "PLA Pro: acabamento brilhante padrão, ótima precisão. PLA Silk: superfície com efeito metálico/sedoso que disfarça as camadas. PLA Matte: acabamento fosco e opaco, aparência mais profissional. Todos têm a mesma durabilidade.",
      },
      {
        q: "As peças são resistentes?",
        a: "PLA é firme e rígido, resistente ao uso cotidiano. Para peças funcionais que sofrem impacto intenso ou calor acima de 60°C, fale com a equipe para avaliar o material mais indicado.",
      },
      {
        q: "A cor fica exatamente igual à imagem?",
        a: "As cores podem ter pequenas variações de lote para lote, assim como qualquer produto físico. Fazemos o possível para manter consistência, mas pequenas diferenças de tonalidade são normais.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: "Atualmente aceitamos Pix. O código é gerado automaticamente após confirmar o pedido — é só pagar pelo app do banco. Em breve teremos cartão de crédito e débito.",
      },
      {
        q: "Posso cancelar meu pedido?",
        a: "Sim, desde que a impressão não tenha começado (status 'Em Fila' ou 'Aguardando Pagamento'). Após início da produção não é possível cancelar. Entre em contato pelo WhatsApp o quanto antes.",
      },
      {
        q: "O que acontece se a peça chegar danificada?",
        a: "Reimprimos e reenviamos sem custo. Envie uma foto pelo WhatsApp mostrando o dano dentro de 7 dias após o recebimento.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Aceitamos arquivos STL e OBJ, formatos padrão para impressão 3D. Se tiver outro formato (STEP, Fusion 360, SolidWorks), entre em contato — geralmente conseguimos converter.",
      },
      {
        q: "Não tenho arquivo 3D. Posso encomendar assim mesmo?",
        a: "Sim! Nosso catálogo tem dezenas de modelos prontos. Escolha, configure o material e finalize. Para algo exclusivo, fale pelo WhatsApp sobre modelagem sob medida.",
      },
      {
        q: "Qual o tamanho máximo que vocês imprimem?",
        a: "Até 300×300×350mm. Para peças maiores, podemos dividir em partes e montar. Consulte pelo WhatsApp.",
      },
    ],
  },
];
...
function StepCard({
  ...
  return (
    ...
    >
      <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/15 mb-4 block">
        {num}
      </span>
...
export default function HowItWorks() {
  ...
  return (
    <div className="pb-12 min-h-screen">
      ...
      <section className="container-section pt-12 pb-16 sm:pt-16 sm:pb-24">
        ...
        >
          ...
          <p className="text-lg text-white/45 font-medium leading-relaxed max-w-xl mb-10">
            A INOVAPRO3D transforma arquivos digitais em objetos reais com precisão industrial.
            Catálogo pronto, produção no Pará, entrega em todo o Brasil.
          </p>
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <div
                key={chip.text}
                className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/[0.03] text-[10px] font-black uppercase tracking-wider text-white/50"
              >
      ...
      <section className="container-section pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <motion.div
            ...
            transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
          >
            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-primary/60 mb-4">
              O que é isso?
            </p>
            ...
            <div className="space-y-4 text-sm text-white/45 font-medium leading-relaxed">
              <p>
                Imagine uma impressora comum — mas em vez de tinta no papel, ela deposita plástico
                derretido camada por camada, construindo um objeto tridimensional do zero.
              </p>
              <p>
                Você escolhe o modelo (do nosso catálogo ou um personalizado), o material e a cor.
                Nós configuramos a máquina, imprimimos, embalamos e entregamos na sua porta.
              </p>
              <p>
                O resultado? Um objeto real, resistente e com acabamento de alta qualidade — seja
                uma miniatura, uma peça funcional, um presente único ou um protótipo.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="aspect-[4/3] w-full rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border border-primary/10 flex flex-col items-center justify-center gap-3">
              ...
              <span className="text-xs font-black uppercase tracking-widest text-primary/30 text-center px-6">
                Bambu Lab P2S
              </span>
              <span className="text-[10px] text-white/20 font-medium text-center px-8 leading-relaxed">
                Impressora de alta velocidade — adicione uma foto real aqui no admin
              </span>
            </div>
            <p className="text-[10px] text-white/20 font-medium mt-3 text-center italic">
              Bambu Lab P2S — Impressora de alta velocidade e precisão industrial
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="container-section pb-20">
        <div className="mb-10">
          <p className="text-[9px] font-black uppercase tracking-[0.3em] text-primary/60 mb-3">
            Passo a passo
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StepCard
            ...
            desc="Navegue pelo catálogo e encontre a peça que quer. Miniaturas, decoração, funcional, games — dezenas de opções."
          />
          <StepCard
            num="02"
            icon={<Settings className="w-5 h-5" />}
            title="Configure"
            desc="Escolha o material (PLA Pro, Silk ou Matte), a cor e a quantidade. O preço atualiza na hora."
          />
          <StepCard
            num="03"
            icon={<Zap className="w-5 h-5" />}
            title="Produzimos"
            desc="Sua peça entra na fila de impressão. Você acompanha cada etapa em tempo real pelo painel."
          />
          <StepCard
            num="04"
            icon={<Package className="w-5 h-5" />}
            title="Entregamos"
            desc="Embalada com cuidado e enviada pelos Correios com código de rastreamento. Entrega em todo o Brasil."
          />
        </div>
      </section>
      ...
      <section className="container-section pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <MaterialCard
            ...
            name="PLA Pro"
            tag="Padrão Premium"
            desc="Acabamento brilhante, alta precisão de detalhes. O melhor custo-benefício para a maioria das peças."
            best="Protótipos, decoração e uso geral"
          />
          <MaterialCard
            color="#C0A080"
            name="PLA Silk"
            tag="Efeito Metálico"
            desc="Superfície sedosa que reflete a luz e disfarça as camadas de impressão. Aspecto premium e sofisticado."
            best="Presentes, miniaturas colecionáveis"
          />
          <MaterialCard
            color="#888888"
            name="PLA Matte"
            tag="Acabamento Fosco"
            desc="Visual opaco e sóbrio que esconde as linhas de impressão. Aparência mais profissional e moderna."
            best="Objetos funcionais, decoração moderna"
          />
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="aspect-[4/3] w-full rounded-3xl bg-gradient-to-br from-white/5 via-white/[0.02] to-transparent border border-white/[0.08] flex flex-col items-center justify-center gap-3">
              ...
              <span className="text-xs font-black uppercase tracking-widest text-white/15 text-center px-6">
                Close-up de peça impressa
              </span>
              <span className="text-[10px] text-white/10 font-medium text-center px-8 leading-relaxed">
                Adicione uma foto de detalhe aqui no admin
              </span>
            </div>
            <p className="text-[10px] text-white/20 font-medium mt-3 text-center italic">
              Detalhe de impressão — resolução de camada 0.1mm
            </p>
          </motion.div>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <h2 className="font-display text-3xl font-black uppercase tracking-tight">
                Do catálogo para as suas mãos
              </h2>
            </div>
            <Link
              to="/catalogo"
              className="text-[9px] font-black uppercase tracking-widest text-white/30 hover:text-primary transition-colors flex items-center gap-1 shrink-0"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {exampleProducts.map((p, i) => (
              ...
              >
                <Link
                  to={`/produto/${p.id}`}
                  className="block group rounded-2xl border border-white/[0.06] bg-white/[0.02] overflow-hidden hover:border-primary/30 transition-all"
                >
                  ...
                  <div className="p-3">
                    <p className="text-[10px] font-black uppercase tracking-tight leading-tight line-clamp-2 text-white/60 group-hover:text-white transition-colors">
                      {p.name}
                    </p>
          ...
          {[
            {
              ...
              desc: "Cada peça passa por inspeção visual antes de ser embalada. Se não atender ao padrão, reimprimimos.",
            },
            {
              icon: <Shield className="w-5 h-5" />,
              title: "Embalagem reforçada",
              desc: "Protegemos com espuma e caixa rígida para que sua peça chegue sem danos, seja qual for a distância.",
            },
            {
              icon: <Package className="w-5 h-5" />,
              title: "Rastreamento incluso",
              desc: "Código de rastreamento dos Correios enviado automaticamente quando seu pedido é despachado.",
            },
          ].map((item, i) => (
            <motion.div
              key={item.title}
        ...
        <AnimatePresence mode="popLayout">
          {filtered.length === 0 ? (
            ...
            >
              ...
              <p className="text-white/30 font-bold text-sm mb-6">
              ...
              {filtered.map((cat, i) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3 pb-3 border-b border-white/[0.05]">
                    ...
                    <span className="text-[9px] font-black text-white/15 bg-white/5 px-2 py-0.5 rounded-full">
                      {cat.items.length}
                    </span>
                  </div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-8">
            <div className="max-w-xl text-center lg:text-left">
              ...
              <p className="text-white text-sm font-medium mb-8 opacity-90">
                Explore o catálogo e faça seu pedido agora. Qualquer dúvida, nossa equipe responde
                em minutos pelo WhatsApp.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                ...
                >
                  <Button
                    variant="outline"
                    className="border-white/30 text-white hover:bg-white/10 rounded-xl h-12 px-8 font-black uppercase tracking-widest text-[10px]"
                  >
