...
export default function MyOrders() {
  ...
  const getStatusIcon = (status: OrderStatus) => {
    switch (status) {
      ...
      case "SLICING":
        return <Scissors className="w-4 h-4 animate-pulse" />;
      case "PRINTING":
  ...
  const getStatusLabel = (status: OrderStatus) => {
    switch (status) {
      ...
      case "SLICING":
        return "Fatiamento (Slicer)";
      case "PRINTING":
        return "Imprimindo (Manufatura)";
      case "FINISHING":
        return "Acabamento (Q.A.)";
      case "READY":
      ...
      <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-4 sm:gap-8">
        <div>
          ...
          <p className="text-white/40 font-medium text-lg">
            Acompanhe o workflow de materialização das suas peças em tempo real.
          </p>
        </div>
      ...
      <AnimatePresence mode="wait">
        {orders.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-3xl font-black font-display uppercase tracking-tight mb-4">
              Nenhum Projeto Ativo
            </h3>
            <p className="text-white/30 max-w-sm mx-auto mb-12">
              Inicie sua jornada de manufatura digital explorando nosso catálogo de protótipos
              prontos.
            </p>
            <Link to="/catalogo">
                ...
                <div className="flex flex-col md:flex-row justify-between gap-6 lg:gap-12 relative z-10">
                  ...
                  <div className="flex flex-col justify-between items-end min-w-[200px]">
                    <div className="text-right">
                      <p className="text-[10px] text-white/30 uppercase font-black mb-2 tracking-widest">
                        Comprometimento
                      </p>
                    ...
                    <div className="flex gap-4">
                      <Button
                        variant="outline"
                        size="sm"
                        className="h-14 px-6 rounded-2xl text-[10px] font-black uppercase tracking-widest border-white/10 group-hover:border-primary/50 transition-all"
                      >
                        LAUDO TÉCNICO
                      </Button>
                      <Button
                        size="sm"
                        className="h-14 px-6 rounded-2xl text-[10px] font-black uppercase tracking-widest gap-2"
                      >
                    ...
                    return (
                      <div className="relative">
                        ...
                        <motion.div
                          ...
                          initial={{ width: 0 }}
                          animate={{
                            width: `${Math.min(current / (steps.length - 1), 1) * (100 - 12)}%`,
                          }}
                          ...
                          {steps.map((step, i) => {
                            ...
                            return (
                              <div key={step.label} className="flex flex-col items-center gap-2">
                                ...
                                <span
                                  className={`text-[8px] font-black uppercase tracking-wider hidden sm:block ${
                ...
                {order.trackingCode &&
                  ...
                  order.status !== "CANCELED" && (
                    <div className="mt-8 p-4 sm:p-6 rounded-3xl bg-white/[0.02] border border-white/5 flex items-center justify-between">
                      ...
                      <Button
                        variant="outline"
                        className="border-white/10 hover:border-blue-500/50 hover:text-blue-400 gap-2 h-12"
                        onClick={() =>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-white/40 font-medium italic">
                            Copie o código abaixo ou escaneie o QR Code para faturar seu pedido.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pt-4 border-t border-white/5 items-center">
                      <div className="md:col-span-8 space-y-2">
                        ...
                        <div className="p-3 bg-black/40 rounded-xl border border-white/5 font-mono text-[10px] text-white/60 select-all break-all overflow-y-auto max-h-[80px]">
                          00020101021226830014br.gov.bcb.pix2561api.INOVAPRO3D.com.br/pix/qr/v2/cob/order_
                          {order.id}_{(order.total || 0).toFixed(0)}
                        </div>
                      </div>
                      ...
                      <div className="md:col-span-4 flex justify-center sm:justify-end">
                        <div className="p-3 bg-white rounded-2xl flex flex-col items-center gap-1.5 w-[140px] shadow-2xl relative group">
                          <img
                            ...
                            alt="Pix QR Code"
                          />
                          <span className="text-[8px] font-black text-black/60 uppercase tracking-wider">
                            Aponte a Câmera
                          </span>
                        </div>
                      </div>
