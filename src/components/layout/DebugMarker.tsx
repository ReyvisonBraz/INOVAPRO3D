    ...
    <div className="space-y-3">
      {[
        ...
        },
        {
          key: "fb",
          label: "Firebase",
          value: <span className="text-[10px] font-mono font-bold text-green-400">Conectado</span>,
        },
        {
          key: "ui",
          label: "Modo UI",
          value: <span className="text-[10px] font-mono text-white/50">Refined-Dark</span>,
        },
      ].map((row) => (
